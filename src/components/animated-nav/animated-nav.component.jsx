    ...
    const openMenu = () => {
        try {
           if (t1.reversed()) {
                ...
                .to(closeRef.current, { zIndex: 1, opacity: 1, PointerEvents: 'all' }, '-=.8')
		...
		<Wrapper ref={wrapperRef} className='wrapper'>
			<Navigation ref={navRef} className='nav'>
				...
				<Menu className='menu'>
					<li className='item'>
						<MobileNavLink
                        className='link' to='/' onClick={closeMenu}>Home</MobileNavLink>
					</li>
					<li className='item'>
						<MobileNavLink className='link' to='/shop'
                        onClick={closeMenu}>Shop</MobileNavLink>
					</li>
					<li className='item'>
						<MobileNavLink
                ...
                <img className='nav' src='../../images/mobile-nav-bg.jpg' />
			</Navigation>
		</Wrapper>
	)
}
